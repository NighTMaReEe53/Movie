...
const Favourite = () => {
  ...
  const GET_ITEM_FROM_LOCAL: any = localStorage.getItem("pageFavourite");
    ...
    <div className="movie-box" key={el.id}>
      ...
      <div className="stars flex justify-between px-2 my-1">
        ...
        <div className="details flex gap-1">
          <span>
            <Heart size={18} onClick={() => dispatch(ADD_MOVIE(el))} />
          </span>
        </div>
      </div>
      <div className="text">
  ...
  return (
    <div className="watch-content p-3 ">
      <img src="./Image/like.png" className="bottom-right" alt="" />
      <div className="main-title flex justify-between items-center">
        <div className="flex items-center gap-2">
          <h2>
            Your Favourite <span>List</span>
          </h2>
        </div>
      </div>
